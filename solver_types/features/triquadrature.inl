...
struct triquadrature
{
    ...
    static std::pair<
        std::vector<boost::geometry::model::d2::point_xy<double, boost::geometry::cs::cartesian>>,
        std::vector<double>
    >
    get_quad_2(
    ...
    )
    {
        ...
        auto coordinate_transformations = get_trans_from_reference_to_arbitrary(triangle_points);
        ...
        const std::vector<point_2d> quad_points_calculated = {
            point_2d(
    ...
    template<typename point_2d>
    static std::pair<
        std::function<double(const point_2d&)>,
        std::function<double(const point_2d&)>
    >
    get_trans_from_reference_to_arbitrary(
    ...
    )
    {
        ...
        std::function<double(const point_2d&)> g_1 = [&triangle_points](const point_2d& quadrature_point)
        {
        ...
        std::function<double(const point_2d&)> g_2 = [&triangle_points](const point_2d& quadrature_point)
        {
